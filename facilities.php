                     ...
                     <nav class="navigation navbar navbar-expand-md navbar-dark ">
                        ...
                        <div class="collapse navbar-collapse" id="navbarsExample04">
                           <ul class="navbar-nav mr-auto">
                              ...
                              <li class="nav-item">
                                 <a class="nav-link" href="signin.php">LOGIN/SIGN_UP</a>
                              </li>
                           </ul>
                        </div>
                     </nav>
            ...
            <div class="row">
               <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 ">
                  <div class="product_box">
                     <figure><img src="images/labour.jpg" alt="#"/></figure>
                     <h3>labour</h3>
                  </div>
               </div>
               <div class="col-xl-4 col-lg-3 col-md-3 col-sm-12">
                  <div class="product_box">
                     <figure><img src="images/transport.jpg" alt="#"/></figure>
                     <h3 >transport</h3>
                  </div>
               </div>
               <div class="col-xl-4 col-lg-3 col-md-3 col-sm-12 ">
                  <div class="product_box">
                     <figure><img src="images/coldstorage.jpg" alt="#"/></figure>
                     <h3>cold storage</h3>
                  </div>
               </div>
               ...
               <div class="col-xl-4 col-lg-3 col-md-3 col-sm-12 ">
                  <div class="product_box">
                     <figure><img src="images\tools.jpg" alt="#"/></figure>
